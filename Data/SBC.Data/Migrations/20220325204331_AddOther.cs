        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UniqueGroupKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coaches_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCoaches", x => new { x.CategoryId, x.CoachId });
                    table.ForeignKey(
                        name: "FK_CategoryCoaches_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageCoaches", x => new { x.LanguageId, x.CoachId });
                    table.ForeignKey(
                        name: "FK_LanguageCoaches_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LanguageCoaches_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCoachSessions", x => new { x.UserId, x.CoachId });
                    table.ForeignKey(
                        name: "FK_UserCoachSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCoachSessions_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseLectures", x => new { x.CourseId, x.LectureId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseLectures_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCoaches_CoachId",
                table: "CategoryCoaches",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_Coaches_CompanyId",
                table: "Coaches",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLectures_IsDeleted",
                table: "CourseLectures",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_CourseLectures_LectureId",
                table: "CourseLectures",
                column: "LectureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageCoaches_CoachId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCoachSessions_CoachId",
                table: "UserCoachSessions",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCoachSessions_IsDeleted",
                table: "UserCoachSessions",
                column: "IsDeleted");
