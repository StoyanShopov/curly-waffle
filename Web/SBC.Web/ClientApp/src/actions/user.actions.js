...
export const register = (fullName, companyName, email, password, confirmPassword) => (dispatch) => {
    dispatch(request({ email }));

    return userService.register(fullName, companyName, email, password, confirmPassword).then(
        (data) => {
            dispatch(success(data));
